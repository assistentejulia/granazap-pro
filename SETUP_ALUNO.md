...
```
MEU_GITHUB_URL=https://github.com/assistentejulia
GITHUB_TOKEN=YOUR_GITHUB_TOKEN_HERE

SUPABASE_PROJECT_URL=https://supabase.com/dashboard/new
...
2. **Executar SQL no Supabase:**
   ...
   - Abra o arquivo: `supabase/setup_cron_jobs.sql`
   - Copie todo o conteúdo
   - Cole no SQL Editor
   - Execute (Run)
   - Isso vai configurar os Cron Jobs para atualizar preços de investimentos
