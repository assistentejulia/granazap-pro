...
export function SubscriptionCard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium text-foreground">{t('settings.yourPlan')}</h3>
        <p className="text-sm text-muted-foreground">{t('settings.manageSubscription')}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4">
              <div className={cn(
                ...
                isPro ? "bg-purple-500/10 text-purple-400" : "bg-green-500/10 text-green-500"
              )}>
        ...
        <div className="bg-card border border-border rounded-xl p-6 flex flex-col justify-center">
          <h4 className="font-medium text-foreground mb-6">{t('settings.subscriptionDetails')}</h4>
