...
export function NotificationSettings() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium text-foreground">{t('settings.notificationConfig')}</h3>
      ...
      <div className="bg-card border border-border rounded-xl p-6 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-medium text-foreground">{t('settings.enableNotifications')}</span>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-medium text-foreground">{t('settings.whatsapp')}</span>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              type="checkbox"
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-medium text-foreground">{t('settings.email')}</span>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              type="checkbox"
        ...
        <div className="space-y-3 pt-4 border-t border-border">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-medium text-foreground">{t('settings.reminderTime')}</span>
          </div>
          <select
            value={settings.reminderTime}
            onChange={e => setSettings({ ...settings, reminderTime: e.target.value })}
            disabled={!settings.enabled}
            className="w-full bg-background border border-input rounded-lg px-4 py-3 text-foreground appearance-none focus:outline-none focus:border-blue-500 disabled:opacity-50"
          >
