      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            disabled={deleting}
            className="flex-1 bg-destructive hover:bg-destructive/90 text-destructive-foreground px-6 py-3 rounded-lg font-medium transition-colors disabled:opacity-50"
          >
