...
export function LogoSettings() {
  ...
  const [pwaIcon192Url, setPwaIcon192Url] = useState('');
  const [pwaIcon512Url, setPwaIcon512Url] = useState('');
  ...
  useEffect(() => {
    if (settings) {
      ...
      setPwaIcon192Url(settings.pwa_icon_192_url || '');
      setPwaIcon512Url(settings.pwa_icon_512_url || '');
      setAppleTouchIconUrl(settings.apple_touch_icon_url || '');
    }
  }, [settings]);
