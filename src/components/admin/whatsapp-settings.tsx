    ...
    <div className="space-y-6">
      ...
      <div className="bg-card border border-border rounded-xl p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-foreground font-medium">Habilitar Botão WhatsApp</h3>
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${habilitado ? 'bg-green-600' : 'bg-secondary'
              }`}
          >
            <span
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 bg-background border border-input rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:border-green-500"
          />
      ...
      {habilitado && urlWhatsApp && (
        <div className="bg-card border border-border rounded-xl p-6">
          <h3 className="text-foreground font-medium mb-4">Preview do Botão</h3>
